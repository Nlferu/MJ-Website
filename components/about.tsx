    ...
    return (
        <section className="max-w-[51rem] text-base sm:text-lg text-center mb-0 sm:mb-20 mt-[-8rem]" ref={ref} id="about">
            ...
            <motion.div
                ...
                viewport={{ once: true }}
            >
                Hello! I&apos;m Marta. Since high school, I have known that I want to be an accountant. Determined to turn my passion into a profession, I
                pursued a comprehensive education, earning both a bachelor&apos;s and master&apos;s degree from the prestigious University of Economics in
                Krakow.
                <span className="my-4">
                ...
                ambitiously expand my competencies. I&apos;m fueled by a genuine passion for the intricacies of accounting and the dynamic realm of human
                resources.
            </motion.div>
        </section>
    )
